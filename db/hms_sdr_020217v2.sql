...
insert  into `roomsales`(`TransactionNo`,`RoomNo`,`GuestID`,`Pax`,`CheckInDateTime`,`Duration`,`ExpectedCheckOut`,`Deposit`,`IsDiscounted`,`DicountedRate`,`RoomCharges`,`OtherCharges`,`TotalCharge`,`Remarks`,`IsCurrentlyCheckedIn`) values ('0000000001',9,'0000000008',2,'2017-02-02 20:40:40',142,'2017-02-03 01:40:40',0.00,0,0,9430.00,0.00,9430.00,'Transfered from Room No. : 4\nTransfered from Room No.: 4\nTransfered from Room No.: 9\nTransfered from Room No.: 2\nTransfered from Room No.: 9\nTransfered from Room No.: 3\nTransfered from Room No.: 9\nTransfered from Room No.: 4',1);
